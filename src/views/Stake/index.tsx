...
function Stake() {
    ...
    const hasAllowance = useCallback(
        token => {
            if (token === "idk") return stakeAllowance > 0;
            if (token === "sidk") return unstakeAllowance > 0;
            return 0;
        },
        [stakeAllowance],
    );
                    ...
                    <Grid className="stake-card-grid" container direction="column" spacing={2}>
                        <Grid item>
                            <div className="stake-card-header">
                                <p className="stake-card-header-title">IDK Staking (¯\_(ツ)_/¯, ¯\_(ツ)_/¯)</p>
                                <RebaseTimer />
                            </div>
                        </Grid>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <div className="stake-card-index">
                                            ...
                                            <p className="stake-card-metrics-value">{currentIndex ? <>{trim(Number(currentIndex), 2)} IDK</> : <Skeleton width="150px" />}</p>
                                        </div>
                                    </Grid>
                                </Grid>
                            </div>
                        ...
                        <div className="stake-card-area">
                            {!address && (
                                <div className="stake-card-wallet-notification">
                                    ...
                                    <p className="stake-card-wallet-desc-text">Connect your wallet to stake IDK tokens!</p>
                                </div>
                            )}
                            {address && (
                                <div>
                                    <div className="stake-card-action-area">
                                        ...
                                        <div className="stake-card-action-help-text">
                                            {address && ((!hasAllowance("idk") && view === 0) || (!hasAllowance("sidk") && view === 1)) && (
                                                <p>
                                    ...
                                    <div className="stake-user-data">
                                        <div className="data-row">
                                            ...
                                            <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{trim(Number(timeBalance), 4)} IDK</>}</p>
                                        </div>

                                        <div className="data-row">
                                            <p className="data-row-name">Your Staked Balance</p>
                                            <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{trimmedMemoBalance} sIDK</>}</p>
                                        </div>

                                        <div className="data-row">
                                            <p className="data-row-name">Next Reward Amount</p>
                                            <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sIDK</>}</p>
                                        </div>
